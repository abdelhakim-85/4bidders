$(document).ready(function () {
    $('form.d-lg-flex').width($('.navbar-collapse').width() - $('.navbar-nav').width() - 50);
    $('.mobile').width($('.bg-light .container-fluid').outerWidth() - $('.navbar-brand').outerWidth() - $('.navbar-toggler').outerWidth() - 40);
    ...
    function calcHeights() {
        ...
        fullHeightMinusHeader = $(window).height() - $("header").outerHeight() - $('.filter').outerHeight();
